# Timely Message Extension Bot - `timelyMessageExtensionBot`
...
3. Give the bot a handle (ex: `timelyMessageExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://timely.azurewebsites.net/api/messages`
